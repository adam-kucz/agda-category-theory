...
module Construction.Product.Unsafe ⦃ C : Category 𝒰 𝒱 ⦄ where
...
private
  module Properties {A B : obj} ⦃ P : Product A B ⦄ where
    ...
    get-mor f g = !choice (IsProduct.to-product def f g)
    ...
    〈π₁,π₂〉==id : 〈 π₁ , π₂ 〉 == id (A × B)
    〈π₁,π₂〉==id = sym (prod-mor-uniq π₁ π₂ (id (A × B)) (right-unit π₁ , right-unit π₂))
    ...
    product-compose f g i =  prod-mor-uniq (f ∘ i) (g ∘ i) (〈 f , g 〉 ∘ i)
      ((proof π₁ ∘ (〈 f , g 〉 ∘ i)
          ...
          〉 _==_ 〉 f ∘ i             :by: ap (_∘ i) $ π₁-prop f g
        qed) ,
       (proof π₂ ∘ (〈 f , g 〉 ∘ i)
          〉 _==_ 〉 π₂ ∘ 〈 f , g 〉 ∘ i :by: assoc π₂ 〈 f , g 〉 i
          〉 _==_ 〉 g ∘ i             :by: ap (_∘ i) $ π₂-prop f g
        qed))
    ...
    〉 _==_ 〉 〈 g ∘ π₁ ∘ ff' , g' ∘ π₂ ∘ ff' 〉
      :by: prod-mor==
        (proof g ∘ f ∘ π₁
           ...
           〉 _==_ 〉 g ∘ (π₁ ∘ ff') :by: ap (g ∘_) $ sym $ π₁-prop (f ∘ π₁) (f' ∘ π₂)
